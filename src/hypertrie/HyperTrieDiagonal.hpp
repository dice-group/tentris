#ifndef TEST_HYPERTRIEDIAGONAL_HPP
#define TEST_HYPERTRIEDIAGONAL_HPP
...
public:
    ...
    class iterator {
         ...
         */
        void init_poss(const vector<key_pos_t> &key_poss, const key_pos_t &min_card_key_pos) const {// init key_poss
    ...
    public:
        ...
        iterator(
                map<key_part_t, variant<HyperTrie<T> *, T>>::iterator &iter_end) :
                iter(iter_end),
                iter_end(iter_end),
                end(true) {}

    private:
        typename map<key_part_t, variant<HyperTrie<T> *, T>>::iterator iter;

        typename map<key_part_t, variant<HyperTrie<T> *, T>>::iterator iter_end;
...
#endif //TEST_HYPERTRIEDIAGONAL_HPP
