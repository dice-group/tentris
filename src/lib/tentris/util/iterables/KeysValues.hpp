...
namespace tentris::util::iterable::keys {
...
namespace tentris::util::iterable::values {
    template<class Associative>
    class Values {
        Associative &associative;
    public:
...
decltype(auto) keys(Associative &associative) {
    return tentris::util::iterable::keys::Keys(associative);
}

template<class Associative>
decltype(auto) values(Associative &associative) {
    return tentris::util::iterable::values::Values(associative);
}
