...
#include "tentris/tensor/einsum/Subscript.hpp"
...
namespace tentris::tensor::einsum {
	...
	public:
		...
		public:
			friend struct ::fmt::formatter<tentris::tensor::einsum::EinsumPlan::Step>;
		};
	};
}; // namespace tentris::tensor::einsum

template<>
struct fmt::formatter<tentris::tensor::einsum::EinsumPlan::Step> {
	template<typename ParseContext>
	constexpr auto parse(ParseContext &ctx) { return ctx.begin(); }

	template<typename FormatContext>
	auto format(const tentris::tensor::einsum::EinsumPlan::Step &p, FormatContext &ctx) {
