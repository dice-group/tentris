...
namespace tentris::tensor::einsum {
    /**
    ...
    class Subscript {
        ...
        template<typename T>
        using UndirectedGraph = typename ::tentris::util::UndirectedGraph<T>;
    ...
    public:
        friend struct fmt::formatter<tentris::tensor::einsum::Subscript>;

    };
}

template<>
struct fmt::formatter<tentris::tensor::einsum::Subscript> {
    template<typename ParseContext>
    constexpr auto parse(ParseContext &ctx) { return ctx.begin(); }

    template<typename FormatContext>
    auto format(const tentris::tensor::einsum::Subscript &p, FormatContext &ctx) {
