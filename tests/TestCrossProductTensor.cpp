...
vector<MapTensor < int> *>
input_tensors = {&input_tensor_1_2, &input_tensor_1_2, &input_scalar};
...
vector<MapTensor < int> *>
input_tensors = {&input_scalar_0, &input_scalar_1, &input_scalar_2};
